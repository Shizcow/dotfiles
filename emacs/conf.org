...
#+begin_src emacs-lisp
  ...
  :config
  (load-theme 'kooten t)
  (set-face-attribute 'default nil :family "Office Code Pro" :height 102))
#+end_src
...
(setq org-latex-pdf-process
      ...
      '("xelatex -8bit -shell-escape -interaction nonstopmode -output-directory %o %f"
        ...
        "sh -c 'if [ ! -f %b.bbl -o -s %b.bbl ] || [[ $(wc -l < %b.sagetex.sage) != 5 ]] ;then xelatex -8bit -shell-escape -interaction nonstopmode -output-directory %o %f ;fi'"))
#+end_src
